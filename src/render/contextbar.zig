...
fn getHintsForContext(context: Context, theme: *const Theme, allocator: std.mem.Allocator) ![]const Hint {
    ...
    const hints = switch (context) {
        ...
        .normal_mode => &[_]Hint{
            ...
            .{ .key = "v", .action = "select", .color = .{ .standard = .cyan }, .priority = 8 },
            .{ .key = "/", .action = "search", .color = .{ .standard = .cyan }, .priority = 7 },
            .{ .key = "Space p", .action = "palette", .color = .{ .standard = .green }, .priority = 6 },
            .{ .key = "Space f", .action = "files", .color = .{ .standard = .green }, .priority = 5 },
            .{ .key = "Space b", .action = "buffers", .color = .{ .standard = .green }, .priority = 4 },
            .{ .key = "u", .action = "undo", .color = .{ .standard = .yellow }, .priority = 3 },
            .{ .key = "dd", .action = "delete-line", .color = .{ .standard = .red }, .priority = 2 },
            .{ .key = ":q", .action = "quit", .color = .{ .standard = .red }, .priority = 1 },
        },

        .insert_mode => &[_]Hint{
            .{ .key = "ESC", .action = "normal", .color = .{ .standard = .cyan }, .priority = 9 },
            .{ .key = "Typing", .action = "edit text", .color = .{ .standard = .white }, .priority = 8 },
            .{ .key = "←↓↑→", .action = "move", .color = .{ .standard = .white }, .priority = 7 },
            .{ .key = "Backspace", .action = "delete", .color = .{ .standard = .white }, .priority = 6 },
            .{ .key = "Enter", .action = "newline", .color = .{ .standard = .white }, .priority = 5 },
            .{ .key = "Ctrl+Q", .action = "force-quit", .color = .{ .standard = .red }, .priority = 4 },
        },

        .select_mode => &[_]Hint{
            .{ .key = "d", .action = "delete", .color = .{ .standard = .red }, .priority = 9 },
            .{ .key = "y", .action = "yank", .color = .{ .standard = .yellow }, .priority = 8 },
            .{ .key = "hjkl", .action = "extend", .color = .{ .standard = .cyan }, .priority = 7 },
            .{ .key = "ESC", .action = "normal", .color = .{ .standard = .cyan }, .priority = 6 },
            .{ .key = "w/b/e", .action = "word-select", .color = .{ .standard = .cyan }, .priority = 5 },
            .{ .key = "0/$", .action = "line-ends", .color = .{ .standard = .cyan }, .priority = 4 },
        },

        .command_mode => &[_]Hint{
            .{ .key = "Enter", .action = "execute", .color = .{ .standard = .green }, .priority = 9 },
            .{ .key = "ESC", .action = "cancel", .color = .{ .standard = .red }, .priority = 8 },
            .{ .key = ":w", .action = "save", .color = .{ .standard = .yellow }, .priority = 7 },
            .{ .key = ":q", .action = "quit", .color = .{ .standard = .yellow }, .priority = 6 },
            .{ .key = ":wq", .action = "save-quit", .color = .{ .standard = .yellow }, .priority = 5 },
            .{ .key = ":e", .action = "open-file", .color = .{ .standard = .yellow }, .priority = 4 },
        },

        .incremental_search => &[_]Hint{
            .{ .key = "Type", .action = "search", .color = .{ .standard = .yellow }, .priority = 9 },
            .{ .key = "Enter", .action = "confirm", .color = .{ .standard = .green }, .priority = 8 },
            .{ .key = "ESC", .action = "cancel", .color = .{ .standard = .red }, .priority = 7 },
            .{ .key = "n", .action = "next", .color = .{ .standard = .cyan }, .priority = 6 },
            .{ .key = "N", .action = "previous", .color = .{ .standard = .cyan }, .priority = 5 },
            .{ .key = "Backspace", .action = "edit", .color = .{ .standard = .white }, .priority = 4 },
        },

        .palette_open => &[_]Hint{
            .{ .key = "Type", .action = "filter", .color = .{ .standard = .yellow }, .priority = 9 },
            .{ .key = "Enter", .action = "execute", .color = .{ .standard = .green }, .priority = 8 },
            .{ .key = "ESC", .action = "close", .color = .{ .standard = .red }, .priority = 7 },
            .{ .key = "↑↓", .action = "navigate", .color = .{ .standard = .cyan }, .priority = 6 },
            .{ .key = "Backspace", .action = "edit", .color = .{ .standard = .white }, .priority = 5 },
        },

        .file_finder_open => &[_]Hint{
            .{ .key = "Type", .action = "search-path", .color = .{ .standard = .yellow }, .priority = 9 },
            .{ .key = "Enter", .action = "open", .color = .{ .standard = .green }, .priority = 8 },
            .{ .key = "ESC", .action = "close", .color = .{ .standard = .red }, .priority = 7 },
            .{ .key = "↑↓", .action = "navigate", .color = .{ .standard = .cyan }, .priority = 6 },
            .{ .key = "Backspace", .action = "edit", .color = .{ .standard = .white }, .priority = 5 },
        },
        ...
        .buffer_switcher_open => &[_]Hint{
            .{ .key = "↑↓", .action = "select", .color = .{ .standard = .cyan }, .priority = 9 },
            .{ .key = "Enter", .action = "switch", .color = .{ .standard = .green }, .priority = 8 },
            .{ .key = "ESC", .action = "close", .color = .{ .standard = .red }, .priority = 7 },
            .{ .key = "Space c", .action = "close-buffer", .color = .{ .standard = .yellow }, .priority = 6 },
        },

        .pending_command => &[_]Hint{
            .{ .key = "w", .action = "word", .color = .{ .standard = .cyan }, .priority = 9 },
            .{ .key = "d", .action = "line", .color = .{ .standard = .cyan }, .priority = 8 },
            .{ .key = "$", .action = "to-end", .color = .{ .standard = .cyan }, .priority = 7 },
            .{ .key = "0", .action = "to-start", .color = .{ .standard = .cyan }, .priority = 6 },
            .{ .key = "ESC", .action = "cancel", .color = .{ .standard = .red }, .priority = 5 },
        },
    };
